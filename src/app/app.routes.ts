...
export const routes: Routes = [
  ...
  { path: 'receptionist', loadComponent: () => import('./components/receptionist/receptionist.component').then(m => m.ReceptionistComponent), canActivate: [receptionistGuard] },
  ...
  { path: 'checkin', loadComponent: () => import('./components/checkin/checkin.component').then(m => m.CheckInComponent), canActivate: [authGuard] },
